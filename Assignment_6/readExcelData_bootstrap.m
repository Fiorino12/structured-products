function [dates, rates] = readExcelData_bootstrap( filename, formatData)
...
[~, incr_swaps] = xlsread(filename, 1, 'C39:C56');
incr_swaps = str2double(strrep(incr_swaps, 'y', ''));

dates.swaps = finddates(dates.settlement, incr_swaps );
